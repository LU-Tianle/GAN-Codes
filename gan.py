...
class Gan:
    ...
    def train(self, dataset, batch_size, epochs, noise_dim,
        ...
        :param save_intervals: save check points and generated images every interval epochs
        ...
        image_channel = dataset.output_shapes.as_list()[0]
        ...
        with tf.Session() as sess:
            ...
            for epoch in range(epochs):  # training loop
                ...
                try:
                    ...
                    pass
                print('Time taken for epoch {} is {:04d} sec'.format(epoch + 1, time.time() - epoch_start_time))
                if (epoch + latest_check_point + 1) % save_intervals == 0:  # saving (checkpoint) the model every interval epochs
                    ...
                    self.__generate_and_save_images(predictions, images_per_row, image_channel, epoch + 1)
            ...
            print('Time taken for training is {:04d} min'.format((time.time() - training_start_time) / 60))
